...
//    HMSelectionIndicatorFillsSegmentBottom=2,
    HMSelectionIndicatorDot = 2
};

@interface HMSegmentedControl : UIControl

@property (nonatomic, strong) NSMutableArray *sectionTitles;//文字是怎么显示出来的呢？
...
@property (nonatomic, assign) CGFloat IndicatorOffset2Bottom;
